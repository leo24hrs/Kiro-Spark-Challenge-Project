 ...
 */
export async function rollbackReaper(clone_url, original_command) {
    ...
    try {
        ...
        if (rollbackSucceeded && tableName && preCount !== null) {
            try {
                const postCountResult = await client.query(`SELECT COUNT(*) AS cnt FROM ${tableName}`);
...
//# sourceMappingURL=rollback-reaper.js.map