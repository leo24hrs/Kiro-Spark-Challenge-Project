 ...
 */
function assertCloneUrl(clone_url) {
    let hostname;
    try {
        hostname = new URL(clone_url).hostname;
    }
    catch {
        throw new Error('Refusing to execute on non-clone URL: only Neon branch URLs are permitted');
    }
 ...
 */
export async function executeOnClone(clone_url, sql_command) {
...
//# sourceMappingURL=execute-on-clone.js.map